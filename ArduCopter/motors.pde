...
#define DISARM_DELAY            2000000  // PRH to stop log stopping
#define AUTO_DISARMING_DELAY    1500000  // PRH to stop log stopping
...
{
  return; //PRH hack to stop motors disarming
